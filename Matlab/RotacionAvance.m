function robots = RotacionAvance(robots,DELTA_ROTACION,N,W,ALFA_POTENCIAL,DELTA_AVANCE,SIGMA_ROTACION,MEDIA_RUIDO,SIGMA_POTENCIAL)
%Funcion que realiza una iteracion del algoritmo para todos los robots
    ...
    for robot_actual=1:N
        ...
        thethaProm = 0;
        divprom = 0;
        thetha = BarridoFrecuencia(robot_actual,robots,DELTA_ROTACION,ALFA_POTENCIAL,N,SIGMA_ROTACION,MEDIA_RUIDO,SIGMA_POTENCIAL);
